...
func PostsHandler(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodGet:
		...
		posts, err := GetAllPosts(category) // Call the function from post.go
		if err != nil {
	...
	case http.MethodPost:
		...
		err = CreatePost(&post) // Call the function from post.go
		if err != nil {
	...
	case http.MethodDelete:
		...
		err := DeletePost(postID) // Call the function from post.go
		if err != nil {
